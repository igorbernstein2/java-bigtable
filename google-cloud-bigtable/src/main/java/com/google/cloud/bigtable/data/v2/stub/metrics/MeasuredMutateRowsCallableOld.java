 ...
 *
 * @deprecated Please use {@link MeasuredMutateRowsCallable}.
 */
@InternalApi
@Deprecated
public class MeasuredMutateRowsCallableOld extends UnaryCallable<MutateRowsRequest, Void> {
  ...
  @InternalApi
  public MeasuredMutateRowsCallableOld(
